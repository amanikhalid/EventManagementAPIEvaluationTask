    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 10, 18, 7, 22, 34, 651, DateTimeKind.Utc).AddTicks(6412), "AI & Robotics", "Muscat", 200, "Tech Conference" },
                    { 2, new DateTime(2025, 10, 28, 7, 22, 34, 651, DateTimeKind.Utc).AddTicks(7270), "New Startups", "Dubai", 100, "Startup Pitch" }
                });
